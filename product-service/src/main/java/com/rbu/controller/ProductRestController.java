...
public class ProductRestController {
	...
	@PostMapping	// http://localhost:9002/api/v1/products
	...
	@GetMapping("/{code}")	// http://localhost:9002/api/v1/products/101
	...
	@GetMapping		// http://localhost:9002/api/v1/products
	public ResponseEntity<List<Product>> list() {
		List<Product> list = service.listAll();
		return new ResponseEntity<List<Product>>(list, HttpStatus.FOUND);
	}
	
	@GetMapping("/range")	// http://localhost:9002/api/v1/products/range?min=500&max=2000
