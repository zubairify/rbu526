...
public class CustomerRestController {
	...
	@PostMapping(consumes = "application/json")	// http://localhost:9001/api/v1/customers
	...
	@GetMapping("/{id}")	// http://localhost:9001/api/v1/customers/123
	...
	@GetMapping		// http://localhost:9001/api/v1/customers
	public ResponseEntity<List<Customer>> listAll() {
		List<Customer> list = service.listAll();
		return new ResponseEntity<List<Customer>>(list, HttpStatus.FOUND);
	}
	
	@GetMapping("/cell")	// http://localhost:9001/api/v1/customers/cell?mobile=34349239
